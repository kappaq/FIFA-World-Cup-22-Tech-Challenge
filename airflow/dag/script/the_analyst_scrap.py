...
df_res.to_csv('selenium_theanalyst_scrap_player.csv',header=True, index= None)
...
df_res_gk.to_csv('selenium_theanalyst_scrap_gk.csv',header=True, index= None)
...
cs.execute('CREATE OR REPLACE TABLE "theanalyst_gk" ( "PLAYER" STRING,"MINS-PLAYED" STRING,"GOALS-CONCEDED" STRING,"XGOT-CONCEDED" STRING,"GOALS-PREVENTED" STRING,"GOALS-PREVENTED-RATE" STRING,"SOT-FACED" STRING)')
cs.execute('CREATE OR REPLACE TABLE "theanalyst_players" ( "PLAYER" STRING,"MINS-PLAYED" STRING,"SHOTS" STRING,"SOT" STRING,"GOALS" STRING,"XG" STRING,"CHANCES-CREATED" STRING,"ASSISTS" STRING,"XA" STRING,"PASSES" STRING,"PASS-%" STRING,"TACKLES-WON" STRING,"INT" STRING,"REC" STRING,"SHOT-ENDING" STRING,"GOAL-ENDING" STRING,"CHANCE-CREATING" STRING,"ASSIST" STRING,"TOTAL" STRING,"ATTEMPTS" STRING,"WIN-%" STRING)')


df_players = pd.read_csv("selenium_theanalyst_scrap_player.csv", sep=",")
df_gk = pd.read_csv("selenium_theanalyst_scrap_gk.csv", sep=",")

write_pandas(ctx,df_players,table_name="theanalyst_players")
write_pandas(ctx,df_gk,table_name="theanalyst_gk")