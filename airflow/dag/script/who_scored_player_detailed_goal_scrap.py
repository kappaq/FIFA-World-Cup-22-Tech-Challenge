...
def detailed_goal_zone():
    ...
    df.to_csv('selenium_whoscored_scrap_player_stats_detailed_goal_zone.csv', header=True,
              index=False)
...
def detailed_goal_situations():
    ...
    df.columns = ['No.', 'Player', 'Apps', 'Mins', 'Total', 'OpenPlay', 'Counter', 'SetPiece', 'PenaltyScored', 'Own',
                  'Normal', 'Rating']
    df.to_csv('selenium_whoscored_scrap_player_stats_detailed_goal_situations.csv', header=True,
              index=False)
...
def detailed_goal_body_part():
    ...
    df.to_csv('selenium_whoscored_scrap_player_stats_detailed_goal_body_part.csv', header=True,
              index=False)
...
df = pd.read_csv("selenium_whoscored_scrap_player_stats_detailed_goal_zone.csv", sep=",")
...
df = pd.read_csv("selenium_whoscored_scrap_player_stats_detailed_goal_situations.csv", sep=",")
...
df = pd.read_csv("selenium_whoscored_scrap_player_stats_detailed_goal_body_part.csv", sep=",")
