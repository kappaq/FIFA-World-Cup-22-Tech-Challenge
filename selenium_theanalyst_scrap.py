...
def gk_function():
	...
	j = 0
	k = 0
	headers_gk = driver.find_elements(By.XPATH, ('/html/body/div/div/div/div/div[5]/div[2]/div[2]/div[2]/table/thead'))
...
df_res.to_csv('the_analyst_scrap_player.csv',header=True)
...
df_res_gk.to_csv('the_analyst_scrap_gk.csv',header=True)
